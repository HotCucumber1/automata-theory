...
inline auto NT = [](const std::string& name) { return RuleItem{ name, false }; };
inline auto T = [](const std::string& name) { return RuleItem{ name, true }; };
inline auto EPS = RuleItem{ "#", true };